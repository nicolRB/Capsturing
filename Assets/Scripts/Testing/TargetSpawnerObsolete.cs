...
public class TargetSpawnerObsolete : MonoBehaviour
{
    [Header("Target Definition")]
    public GameObject target;
    public int nextTargetIndex = 0;

    private CastingGameScriptObsolete castingGameScript;
    ...
    void Update()
    {
        if (castingGameScript == null) castingGameScript = Object.FindFirstObjectByType<CastingGameScriptObsolete>();
