...
public class CastingGameScriptObsolete : MonoBehaviour
{
    ...
    public TargetSpawnerObsolete targetSpawner;
    ...
    void Update()
    {
        ...
        if (player.castState != PlayerController.CastState.Channeling)
        {
